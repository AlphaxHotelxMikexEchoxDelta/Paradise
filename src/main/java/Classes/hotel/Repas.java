...
public enum Repas implements Serializable {FormuleContinentale(1,"Formule continentale","_Pain frais, croissants, confitures, beurre\n_Jus d'orange fraîchement pressé\n_Café ou thé",10),
    PetitDejeunerAméricain(2,"Petit Déjeuner Américain","_Œufs brouillés ou au plat\n_Bacon ou saucisses\n_Pommes de terre rissolées\n_Pain grillé\n_Jus de fruits\n_Café ou thé",15),
    PetitDejeunerSanté(3,"Petit Déjeuner Santé","_Yaourt nature avec des fruits frais\n_Muesli ou granola\n_Smoothie aux fruits\n_Pain complet ou bagel\n_Café ou thé",12),
    MenuduChef(4,"Menu du Chef","_Entrée : Salade de chèvre chaud\n_Plat principal : Filet de saumon grillé avec riz pilaf et légumes\n_Dessert : Tarte au citron",25),
    DejeunerRapide(5,"Déjeuner Rapide","_Sandwich au poulet grillé avec frites\n_Boisson gazeuse",12),
    OptionVegetarienne(6,"Option Végétarienne","_Quinoa aux légumes grillés\n_Salade de lentilles\n_Dessert : Panna cotta à la mangue",18 ),
    MenuGourmet(7,"Menu Gourmet","_Amuse-bouche : Velouté de champignons\n_Entrée : Risotto aux fruits de mer\n_Plat principal : Filet mignon de bœuf avec purée de pommes de terre et asperges\n_Dessert : Fondant au chocolat",40),
    DinerThematique(8,"Dîner Thématique","Cuisine italienne :\n_Antipasti\n_Pizza margherita\n_Tiramisu",30),
    DinerLeger(9,"Dîner Léger","_Salade de quinoa aux légumes grillés\n_Poisson poché avec sauce au citron\n_Sorbet aux fruits",28)
    ;
